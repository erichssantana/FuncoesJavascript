// async function criptografar(senhaCripto){
//     const encoder = new TextEncoder(); 

//     const data = encoder.encode(senhaCripto); 

//     const hashBuffer = await crypto.subtle.digest('SHA-256', data); 

//     const hashArray = Array.from(new Uint8Array(hashBuffer)); 

//     const senhaHash = hashArray.map(byte => byte.toString(16).padStart(2, '0')).join('');
...
// Dados de usuários (apenas para demonstração)
    ...
    { nomeusuario: "user2", senha: "db2e7f1bd5ab9968ae76199b7cc74795ca7404d5a08d78567715ce532f9d2669", email: "user2@example.com" }
];



// for (var i = 0; i < usuarios.length; i++){
//     usuarios[i].senha = criptografar(usuarios[i].senha);
// }
